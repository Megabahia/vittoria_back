...
urlpatterns = [
    ...
    path('adm/integraciones/envios/', include(('apps.ADM.vittoria_integraciones_envios.urls', 'integraciones_envios'), namespace='integraciones_envios')),
    ...
    path('mdm/contactos/', include(('apps.MDM.mdm_contactos.urls', 'mdm_contactos'), namespace='mdm_contactos')),
    ...
    path('mdm/asesores/', include(('apps.MDM.mdm_asesores_comerciales.urls', 'asesores'), namespace='asesores')),
    #Modulo MDP
    ...
    path('gd/param/', include(('apps.WOOCOMMERCE.gd_parametrizaciones.urls', 'gd_parametrizaciones'), namespace='gd_parametrizaciones')),
