...
class Megabahia(models.Model):
    ...
    numeroDespacho = models.CharField(max_length=255, null=False)
    ...
    codigoUsuario = models.CharField(max_length=255, null=True, blank=True)
