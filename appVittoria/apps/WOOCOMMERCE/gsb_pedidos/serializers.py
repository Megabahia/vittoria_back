...
class SuperBaratoSerializer(serializers.ModelSerializer):
    ...
    def to_representation(self, instance):
        data = super(SuperBaratoSerializer, self).to_representation(instance)
...
class CreateSuperBaratoSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        """
        return SuperBarato.objects.create(**validated_data)

    def to_representation(self, instance):
        data = super(CreateSuperBaratoSerializer, self).to_representation(instance)
