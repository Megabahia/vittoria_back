...
from .views import (gdc_create_contact,gdc_create_venta,contacts_list,contact_listOne,gdc_validate_contact,contacts_update)
...
urlpatterns = [
    ...
    path('create/venta', gdc_create_venta, name="gdc_create_contact"),
