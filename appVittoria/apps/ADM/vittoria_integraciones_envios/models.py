...
class IntegracionesEnvios(models.Model):
    ...
    provinciaDestino = models.CharField(max_length=255, null=True, blank=True)
    ciudadDestino = models.CharField(max_length=255, null=True, blank=True)
    sectorDestino = models.CharField(max_length=255, null=True, blank=True)
