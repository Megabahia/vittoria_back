...
from ..serializers import (
    NegociosSerializer, NegociosListarSerializer, NegociosImagenSerializer,
    NegocioPrediccionSerializer, NegociosResource
)
...
# logs
from ....ADM.vittoria_logs.methods import createLog, datosTipoLog, datosNegocios
...
def negocio_exportar(request):
    ...
    """
    person_resource = NegociosResource()
