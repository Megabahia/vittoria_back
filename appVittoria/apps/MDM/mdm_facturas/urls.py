...
urlpatterns = [
    ...
    path('reporte/productos', factura_reporte_productos, name="factura_compra_productos"),
    path('reporte/clientes', factura_reporte_clientes, name="factura_compra_productos"),
