...
import openpyxl
# logs
from ...ADM.vittoria_logs.methods import createLog, datosTipoLog, datosProspectosClientes
...
@api_view(['GET'])
@permission_classes([IsAuthenticated])
def prospecto_cliente_exportar(request):
    """
    ...
    """
    person_resource = ProspectosClientesResource()
