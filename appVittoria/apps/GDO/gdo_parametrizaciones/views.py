...
from .serializers import (
    ParametrizacionesSerializer, ParametrizacionesHijoSerializer, ParametrizacionesListaSerializer,
    ParametrizacionesFiltroSerializer, ParametrizacionesTipoSerializer, ParametrizacionesResource
)
...
# logs
from ...ADM.vittoria_logs.methods import createLog, datosParametrizacionesGDO, datosTipoLog
