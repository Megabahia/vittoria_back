...
from .serializers import (
    ...
    ParametrizacionesListaSerializer,
    ParametrizacionesFiltroSerializer,
    ParametrizacionesTipoSerializer,
...
# logs
from ...ADM.vittoria_logs.methods import createLog, datosParametrizacionesMDP, datosTipoLog
