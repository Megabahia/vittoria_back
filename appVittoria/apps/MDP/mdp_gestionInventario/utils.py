...
def enviarCorreoInventario(correo,data):
    subject, from_email, to = f"Se ha completado la carga del inventario.", "08d77fe1da-d09822@inbox.mailtrap.io", \
    correo
    txt_content = f"""
                Registro de inventario
                Se ha completado la carga del inventario
                Atentamente,
                Equipo Vittoria.
        """
    ...
    emailsEnviados = []
    adminsGdc = Usuarios.objects.filter(idRol_id=1)
