...
class ProductosListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Productos
        fields = ['id', 'codigoBarras', 'nombre', 'categoria', 'subCategoria', 'stock', 'estado', 'proveedor', 'idPadre', 'canal', 'stockVirtual', 'descripcion', 'precioVentaA', 'precioVentaB', 'precioOferta', 'imagen_principal', 'prefijo', 'link_catalogo', 'link_tienda']
...
class ProductoSearchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'codigoBarras', 'nombre', 'precioVentaA', 'precioVentaB', 'precioVentaC', 'precioVentaD',
                  'precioVentaE', 'precioOferta', 'stock', 'precioLandingOferta','precio','mensaje','canal','woocommerceId', 'imagen_principal']
